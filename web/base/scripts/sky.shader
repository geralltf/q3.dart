...
//	by Eutectic - 24 Jan 2000					//
//	Phase 2 update: 13 May 2000					//
//									//
//	TOTAL SHADERS: 67						//
//	NO. OF BROKEN SHADERS/COMMENTED OUT: 20				//
//	NO. OF WORKING SHADERS WITH DUPLICATE ENTRIES: 2		//
//	textures/skies/hellsky						//
//	textures/skies/xblacksky					//
//	NO. OF WORKING SHADERS THAT DIDN'T APPEAR IN EDITOR: 2		//
//	textures/blacksky						//
//	textures/toxicsky						//
//	SHADERS THAT DIDN'T BELONG HERE AND MOVED TO PROPER FILE: 13	//
...
//******************************************************//
//	skies/hellsky					//
//	1 duplicate entry: 2nd instance invalid		//
//	commented out					//
//******************************************************//
...
//******************************************************//
//	skies/hellsky2bright				//
//	changed qer_editorimage	to more accurate	//
//	custom image: inteldimredclouds.tga		//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
//******************************************************//
...
//	changed qer_editorimage	to bluetopclouds.tga	//
//	changed redundundant qer_editorimage keyword	//
//	to q3map_lightimage to retain original surface	//
//	light color for compilation			//
//******************************************************//
...
//******************************************************//
//	skies/nightsky_nocloud				//
//	skies/nightsky_nocloud_100			//
//	skies/nightsky_nocloud_1000			//
//	skies/nightsky_nocloud_200			//
//	skies/nightsky_nocloud_400			//
//	skies/nightsky_nocloud_500			//
//	skies/nightsky_nocloud_600			//
//	don't work: commented out 			//
//******************************************************//
...
//******************************************************//
//	skies/nightsky_xian_dm1				//
//	skies/nightsky_xian_dm15			//
//	were using inexistent TGA for editorimage:	//
//	changed qer_editorimage	to more accurate	//
//	custom image: xnight2_up.tga			//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
//******************************************************//
...
//******************************************************//
//	skies/nightsky_xian_dm2				//
//	skies/nightsky_xian_dm3				//
//	don't work: commented out 			//
//******************************************************//
...
//******************************************************//
//	skies/pj_arena2sky				//
//	skyparms was pointing to inexistent skybox TGA	//
//	commented out skyparms keyword			//
//	Phase 2 cleanup					//
//	uncommented out skyparms keyword		//
//******************************************************//
...
//	skies/pj_ctf2_sky				//
//	changed qer_editorimage	to more accurate	//
//	custom image: bluetopclouds.tga			//
//	skyparms was pointing to inexistent skybox TGA	//
//	commented out skyparms keyword			//
//	Phase 2 cleanup					//
//	uncommented out skyparms keyword		//
...
//	changed redundundant qer_editorimage keyword	//
//	to q3map_lightimage to retain original surface	//
//	light color (white) for compilation		//
//******************************************************//
...
//	surface light color (white) for compilation	//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
//******************************************************//
...
//	qer_editorimage	space1_bk.tga			//
//	was using inexistent TGA for lightimage:	//
//	changed q3map_lightimage to retain original	//
//	surface light color (white) for compilation	//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
...
//	was using inexistent TGA for editorimage:	//
//	changed qer_editorimage	to more accurate	//
//	custom image: black_up.tga			//
//	requires user to have Q3Wave CTF mappack	//
//	twpak0.pk3 in baseq3 folder for shader to	//
//	work in game.					//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
...
//	changed qer_editorimage	to more accurate	//
//	image: killsky_1.tga				//
//	added q3map_lightimage set to previous		//
//	qer_editorimage	to retain original surface	//
//	light color for compilation			//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
...
//	skies/toxicsky					//
//	was showing no texmap: added qer_editorimage	//
//	set to more accurate custom image:		//
//	inteldimredclouds.tga				//
//	added q3map_lightimage to retain original	//
//	surface light color (white) for compilation	//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
...
//	toxicsky.tga texmap from sourcename		//
//	shader skies/toxicsky: this prevented it	//
//	from loading in Q3R shader window		//
//	changed qer_editorimage	to more accurate	//
//	custom image: inteldimredclouds.tga		//
//	added q3map_lightimage to retain original	//
//	surface light color (toxicsky) for compilation	//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
//******************************************************//
...
//******************************************************//
//	skies/toxicskytim_dm3				//
//	skies/toxicskytim_dm4				//
//	qer_editorimage keyword was "robbing"		//
//	toxicsky.tga texmap from sourcename		//
//	shader skies/toxicsky: this prevented it	//
//	from loading in Q3R shader window		//
...
//	surface light color (toxicsky) for compilation	//
//	skies/toxicskytim_dm3				//
//	1st skyparms keyword was pointing to inexistent	//
//	skybox TGA + syntax error: commented out	//
//	Phase 2 cleanup					//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
//******************************************************//
...
//******************************************************//
//	skies/toxicskytim_dm5				//
//	skies/toxicskytim_dm7				//
//	were using inexistent TGA for editorimage	//
//	changed qer_editorimage	to more accurate	//
//	custom image: bluetopclouds.tga			//
//	added q3map_lightimage to retain original	//
...
//******************************************************//
//	skies/toxicskytim_dm8				//
//	skies/toxicskytim_dm9				//
//	qer_editorimage keyword was "robbing"		//
//	toxicsky.tga texmap from sourcename		//
//	shader skies/toxicsky: this prevented it	//
//	from loading in Q3R shader window		//
...
//	skies/xblacksky					//
//	qer_editorimage keyword was "robbing"		//
//	blacksky.tga texmap from sourcename		//
//	shader skies/xblacksky: this prevented it	//
//	from loading in Q3R shader window		//
//	changed qer_editorimage to sfx/blackness.tga	//
//	Phase 2 cleanup					//
//	texture robbing issues solved in Build189	//
//	changed qer_editorimage				//
//	back to skies/blacksky.tga			//
//	obsolete or inactive keywords commented out:	//
//	surfaceparm sky					//
//******************************************************//
...
//******************************************************//
//	skies/xblacksky					//
//	1 duplicate entry: 2nd instance unused		//
//	commented out					//
//******************************************************//
...
//******************************************************//
//	castle/sky_castle1				//
//	doesn't belong anywhere + doesn't work:		//
//	commented out					//
//******************************************************//
