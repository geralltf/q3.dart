...
class Input
{
  Map<int,Key> KeyCodes;
  Map<Key,int> Keys;
  Map<Key,bool> KeyPressed;
  
  Input()
  {
    Map<Key,int> m = new Map<Key,int>();
    KeyCodes = new Map();
    
    // TODO: add more keys and key codes as need them here
    KeyCodes[87] = Key.W;
    KeyCodes[83] = Key.S;
    KeyCodes[65] = Key.A;
    KeyCodes[68] = Key.D;
    ...
    KeyCodes[67] = Key.C;
    KeyCodes[73] = Key.I;
    KeyCodes[37] = Key.Left;
    KeyCodes[38] = Key.Up;
    KeyCodes[39] = Key.Right;
    KeyCodes[40] = Key.Down;
    KeyCodes[33] = Key.PageUp;
    KeyCodes[34] = Key.PageDown;
    KeyCodes[16] = Key.LShift;
    KeyCodes[16] = Key.LControl;
    ...
    m[Key.PageUp] = 33;
    m[Key.PageDown] = 34;
    m[Key.LShift] = m[Key.ShiftLeft] = 16;
    m[Key.LControl] = m[Key.ControlLeft] = 17;
    
    Keys = m;
    KeyPressed = new Map();
    
    m.forEach((Key key, int code) {
